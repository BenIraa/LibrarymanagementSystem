...
DefaultTableModel model;
   ...
   public boolean deleteStudent(){
    ...
    private void initComponents() {
        ...
        combobox_coursename.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BIT", "IS", "Computer Science", "Pharmacy", "Medcine", "Computer Engeniering", "Other" }));

        combobox_branchname.setFont(new java.awt.Font("Segoe UI Variable", 0, 18)); // NOI18N
        combobox_branchname.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "UR Huye", "Nyagatare", "KIST", "KIE", "GIKONDO", "Rusizi" }));
